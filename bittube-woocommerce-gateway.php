...
define('BITTUBE_GATEWAY_MAINNET_EXPLORER_URL', 'https://explorer.bittube.cash/');
define('BITTUBE_GATEWAY_TESTNET_EXPLORER_URL', 'https://explorer.bittube.cash/');
define('BITTUBE_GATEWAY_ADDRESS_PREFIX', 0x256ea0);
define('BITTUBE_GATEWAY_ADDRESS_PREFIX_INTEGRATED', 0x276ea0);
define('BITTUBE_GATEWAY_ATOMIC_UNITS', 9);
define('BITTUBE_GATEWAY_ATOMIC_UNIT_THRESHOLD', 10); // Amount under in atomic units payment is valid
define('BITTUBE_GATEWAY_DIFFICULTY_TARGET', 15);
...
function bittube_install() {
    ...
    if($wpdb->get_var("show tables like '$table_name'") != $table_name) {
        $sql = "CREATE TABLE $table_name (
               ...
               payment_id VARCHAR(8) DEFAULT '' NOT NULL,
